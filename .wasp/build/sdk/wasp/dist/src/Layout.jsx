      ...
      <div className="flex flex-col min-h-screen">
        <header className="bg-primary-800 text-white p-4">
          <div className="container mx-auto px-4 py-2 flex justify-between">
            ...
            {user ? (<span className="flex items-center gap-1">
              Hi<span className="font-bold text-secondary-400">{capitalizeFirstLetter((_a = user.identities.username) === null || _a === void 0 ? void 0 : _a.id)}</span> {' '}
              <Tooltip label="Log out" position="bottom">
                <ActionIcon onClick={logout} color="red" variant="subtle" aria-label="Logout" size="lg">
                  <IconLogout size={20}/>
                </ActionIcon>
              </Tooltip>
            </span>) : (<Link to="/login">
